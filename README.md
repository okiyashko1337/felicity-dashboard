...
[PolyForm Noncommercial 1.0.0](LICENSE). Его можно бесплатно использовать,
изучать, изменять и распространять в разрешённых лицензией некоммерческих
целях. Для коммерческого использования требуется отдельная письменная лицензия
от правообладателя — свяжитесь с владельцем репозитория.

...
final class DashboardView extends View {
    interface Listener { void onPageChanged(String metric); void onSettingsRequested(); void onWeatherSettingsRequested(); void onAjaxSettingsRequested(); void onVideoAppRequested(); void onSystemSettingsRequested(); void onCameraRequested(); }
    ...
    private void drawSettings(Canvas c){
        center(c,"SETTINGS",getWidth()/2f,72*scale,16,cyan,true);drawSettingRow(c,0,"FELICITY SERVER",s.serverUrl,"Tap to edit",78*scale,45*scale);drawSettingRow(c,1,"WEATHER LOCATION",s.location,"Tap to choose city",125*scale,45*scale);drawSettingRow(c,2,"AJAX ONVIF",s.ajaxStatus,"Tap to configure",172*scale,45*scale);drawSettingRow(c,4,"VIDEO APP","YouTube / compatible client","Tap to open",219*scale,45*scale);drawSettingRow(c,5,"ANDROID SETTINGS","Brightness · Wi-Fi · system","Tap to open",266*scale,45*scale);
